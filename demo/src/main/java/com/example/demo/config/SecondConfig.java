...
@EnableJpaRepositories(
        // repository包名
        basePackages = "com.example.demo.repository2",
        // 实体管理bean名称
...
public class SecondConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(@Qualifier("secondaryDataSource") DataSource secondDataSource
